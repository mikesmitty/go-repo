...
Patch212:       golang-1.9-bootstrap-binary-path.patch
...
# Fix for race condition in TestUserOverrideFlags https://github.com/golang/go/issues/22584
Patch220:       go-1.9.6-fix-cmd-go-test-race.patch
